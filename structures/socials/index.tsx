    ...
    <div className="flex gap-1">
      {socials.map(({ href, icon }, i) => (
        <Anchor
          ...
          href={href}
          target="_blank"
          className="flex justify-center items-center p-1 size-10 rounded-full bg-gray-50/10 hover:bg-gray-50 dark:bg-gray-900/10 dark:hover:bg-gray-700 transition"
        >
          {icon}
        </Anchor>
      ))}
